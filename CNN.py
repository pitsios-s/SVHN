...
# 
# <img src="http://www.rsipvision.com/wp-content/uploads/2015/04/Slide6.png">
# 
...
def maxpool2d(x, k=2):
    # MaxPool2D wrapper
    return tf.nn.max_pool(x, ksize=[1, k, k, 1], strides=[1, k, k, 1], padding='SAME')    ### other option is average pooling (or combination)
...
# 
# <img src="http://i.imgur.com/bSiNEq6.gif">
# 

# In[ ]:


# usefull http://www.wildml.com/2015/11/understanding-convolutional-neural-networks-for-nlp/
